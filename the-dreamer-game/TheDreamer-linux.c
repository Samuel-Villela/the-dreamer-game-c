...
// Função substituta para _getch() no Linux
char getch() {
...
int main() {// SetConsoleOutputCP(CP_UTF8); // Removido para compatibilidade com Linux
int sorteio;
    ...
    *escolhaMenu = 0;
    ...
    while (*escolhaMenu == 0) 
    {
        ...
        if (*escolhaMenu == 6){
            limparTerminal();
            printfDL("Créditos:\n\n",50);
            printf("Samuel da Rocha da Rocha Villela\n");
